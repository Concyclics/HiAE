...
# Target executables
TARGETS = $(BINDIR)/perf_test $(BINDIR)/func_test $(BINDIR)/HiAE-MAC $(BINDIR)/HiAE-File-AEAD
...
help:
	...
	@echo "  make test             - Build and run functional tests"
...
# Phony targets
.PHONY: all test benchmark clean help perf_test func_test HiAE-MAC HiAE-File-AEAD
